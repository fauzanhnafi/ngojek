...
echo color("red"," ===========================\n");
echo color("red","| SCRIPT GOJEK|\n");
echo color("red","| REGIST & REEDEM |\n");
...
// function change(){
        ...
        sleep(3);
        $boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOJEKINAJA"}');
        ...
        sleep(3);
        $boba19 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOJEKINAJA"}');
